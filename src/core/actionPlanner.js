...
export class ActionPlanner {
  ...
  async plan(text, context = {}) {
    ...
    const prompt = [
      ...
      'Allowed actionType values: capabilities.show, email.read, email.summarize_inbox, email.draft, email.send, sms.send, voice.call, calendar.read, calendar.create, codex.brief, task.create, memory.store, coding.run, crm.twenty.update.',
      ...
      'For coding.run, include params.repo and params.request.',
      'For crm.twenty.update, include params.request.',
